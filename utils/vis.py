...
if __name__ == '__main__':
    ...
    generate_graphs_twoview('pt', '1.0t-graph-pairs-features_superpoint_noresize_2048-LG', all=True, use_max_err=True)
    generate_graphs_twoview('pt', '0.5inliers-5.0t-graph-pairs-features_superpoint_noresize_2048-LG', all=True, use_max_err=True)
    generate_graphs_twoview('pt', '0.5inliers-1.0t-graph-pairs-features_superpoint_noresize_2048-LG', all=True, use_max_err=True)
    ...
    # generate_graphs('cambridge', 'graph-0.5inliers-5.0t-triplets-features_superpoint_noresize_2048-LG', all=True, use_max_err=True, basenames = ['ShopFacade'])
